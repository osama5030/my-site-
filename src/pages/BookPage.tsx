    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const templateParams = {
                ...
                destinationCountry: formData.destinationCountry in countries
                    ? countries[formData.destinationCountry as keyof typeof countries].name
                    : 'N/A', // Use country name, check if exists
